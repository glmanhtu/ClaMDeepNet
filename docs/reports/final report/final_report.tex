...
\end{itemize}
In this work, we will implement several different CNN Model Architectures and make a comparison between them to choose the best one, which perfect match with our requirements and dataset. Those CNN Model Architectures must be popular, well known and created by researching labs or university. 
