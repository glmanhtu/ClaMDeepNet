...
After some researches about this problem, we found the Unsupervised Deep Embedding for Clustering Analysis (DEC)\cite{DBLP:journals/corr/XieGF15} paper, which propose a new method that simultaneously learns feature representations and cluster assignments using deep neural networks to classify unlabeled images.\newline\newline
