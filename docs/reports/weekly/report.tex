...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{images/result_large_dataset_fine_tune}
\caption{Test result}
\end{figure}

\subsection{[googlenet model] Test with googlenet}
...
\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{images/result_large_dataset_ggnet}
\caption{Test result}
\end{figure}

\subsection{[googlenet model] Fine tune from bvlc\_googlenet.caffemodel}

\subsubsection{Training progress}

Train Loss: 0.000152441
Test Loss: 0.129649
Acc: 0.971682

\begin{figure}[H]
\centering
\includegraphics[width=1\textwidth]{images/result_large_dataset_ggnet_finetune}
\caption{Test result}
\end{figure}
